(function($) {
	...
	if($('.mockup-detail-section').length){
		...
		var thumbsCarousel = new Swiper('.shop-detail-section .thumbs-carousel-before', {
	      spaceBetween: 0,
	      slidesPerView: 4,
	      direction: 'vertical',
	      breakpoints: {
		...
		var thumbsCarousel = new Swiper('.shop-detail-section .thumbs-carousel-after', {
	      spaceBetween: 0,
	      slidesPerView: 4,
	      direction: 'vertical',
	      breakpoints: {
	    ...
	    var contentCarousel = new Swiper('.shop-detail-section .content-carousel-before', {
	      spaceBetween: 0,
	      loop:true,
	      navigation: {
	        nextEl: '.swiper-button-next',
	    ...
	    var contentCarousel = new Swiper('.shop-detail-section .content-carousel-after', {
	      spaceBetween: 0,
	      loop:true,
	      navigation: {
	        nextEl: '.swiper-button-next',
