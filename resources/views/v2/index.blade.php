...
<section class="main-slider">
    <div class="main-slider-carousel owl-carousel owl-theme">
        ...
        <div class="slide">
            ...
            <div class="image-layer" style="background-image: url('{{ !empty($sliderImage->getImageSingle($sliderImage->id))? $sliderImage->getImageSingle($sliderImage->id)->getImageInfo():'' }}')"></div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="content-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            @if (!empty($sliderImage->product_id))
                            <div class="title">{{ $sliderImage->product_id }}</div>
                            @endif

                            @if (!empty($sliderImage->caption))

                            <h1>{!! $sliderImage->caption !!}</h1>
                            @endif
                            @if ($sliderImage->short_description)
                            <div class="text">{{ Str::of($sliderImage->short_description)->limit(150) }}</div>
                            @endif
                    ...
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="image">
                                <img src="{{ url('assets/v2/images/main-slider/image-1.png') }}" alt="" />
                            </div>
                        </div>
                    </div>
    ...
    <ul class="social-box">
        ...
        <li><a href="{{ $setting->twitter_link }}">Twitter</a></li>
        @endif
        @if (!empty($setting->facebook_link))
        <li><a href="{{ $setting->facebook_link }}">Facebook</a></li>
        @endif
        @if (!empty($setting->instagram_link))
        <li><a href="{{ $setting->instagram_link }}">Instagram</a></li>
        @endif
    </ul>
    <!-- End Social Box -->
                ...
                <div class="inner-column">
                    ...
                    <div class="images-outer parallax-scene-1">
                        <div class="image" data-depth="0.20">
                            <img src="{{ url('assets/v2/images/resource/business-1.jpg') }}" alt="" />
                        </div>
                        <div class="image-two" data-depth="0.30">
                            <img src="{{ url('assets/v2/images/resource/business-2.jpg') }}" alt="" />
                        </div>
                        <div class="image-three" data-depth="0.70">
                            <img src="{{ url('assets/v2/images/resource/business-3.jpg') }}" alt="" />
                        </div>
                    </div>
                    <div class="print-icon">
                        <img src="{{ url('assets/v2/images/icons/printer.png') }}" alt="" />
                    </div>
                </div>
            </div>
            <!-- Content Column -->
    ...
    <div class="auto-container">
        ...
        <div class="sec-title">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <!-- Button Box -->
                <div class="button-box">
                    <a href="{{ url('services') }}" class="theme-btn btn-style-one clearfix">
                        <span class="btn-wrap">
            ...
            <div class="project-block">
                <div class="inner-box">
                    <div class="image">
                        ...
                        <div class="post-number">{{ $loop->iteration }}</div>
                        <div class="content">
...
<section class="services-section-two">
    ...
    <div class="auto-container">
        ...
        <div class="title-box text-center">
            <h2>How we do it?</h2>
            <p>
                At <span class="big-text">{{ $setting->website_name }}</span>, we believe in a collaborative approach to creating exceptional signage solutions
            ...
            <div class="row clearfix">
                ...
                <div class="service-block-two col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="text">
                            At {{ $setting->website_name }}, customer satisfaction is our top priority. We strive to provide a
            ...
            <div class="images-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                    <div class="image titlt" data-tilt data-tilt-max="4">
                        <img src="{{ url('assets/v2/images/resource/quality.png') }}" alt="" />
                    </div>
                </div>
            </div>
            <!-- Content Column -->
        ...
        <div class="left-column">
            <div class="inner-column">
                ...
                <div class="sec-title">
                    ...
                    <h2>We are just <span>better Quality</span> <br> for over <i>{{ date('Y')-2016 }}+</i> years -</h2>
                ...
                <div class="row clearfix">
                    <div class="column col-lg-5 col-md-6 col-sm-12">
                        ...
                        <div class="d-flex">
                            <div class="circles">
                                <img src="{{ url('assets/v2/images/icons/circles.png') }}" alt="" />
                            </div>
                            <!-- Play Box -->
                            <a href="javascript:;" class="lightbox-video play-box"><span class="fa fa-play"></span><i class="ripple"></i></a>
                        </div>
...
<!-- Testimonial Section -->
@include($version.'_testimonial')
<!-- End Testimonial Section -->

<!-- Faq Section -->
@include($version.'_faq')
<!-- End Faq Section -->
