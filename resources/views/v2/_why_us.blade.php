    ...
    <div class="services py-5 mb-5">
        <div class="auto-container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
                <h2 class="title">Why Choose {{ $setting->website_name }}?</h2>
            </div>
            <div class="row g-5 services-inner featured">
                <p>In today's <span class="big-text">rapidly evolving technology</span> landscape, choosing
                    the right partner is crucial for your business success. At <span class="small-text">{{ $setting->website_name }}</span>, we stand
                ...
                <div class="col-lg-6 left">
                    <div class="list-wrap" data-aos="fade-up">
                        <div class="icon">
                            <img src="{{ url('assets/v2/images/icons/icon-1.svg') }}" alt="icon">
                        </div>
                    ...
                    <div class="list-wrap" data-aos="fade-up">
                        <div class="icon">
                            <img src="{{ url('assets/v2/images/icons/icon-3.svg') }}" alt="icon">
                        </div>
                        <div class="description">
                    ...
                    <div class="list-wrap" data-aos="fade-up">
                        <div class="icon">
                            <img src="{{ url('assets/v2/images/icons/icon-2.svg') }}" alt="icon">
                        </div>
                        <div class="description">
                ...
                <div class="col-lg-6 right">
                    <div class="list-wrap" data-aos="fade-up">
                        <div class="icon">
                            <img src="{{ url('assets/v2/images/icons/icon-6.svg') }}" alt="icon">

                        </div>
                        <div class="description">
                            <h4><span>Customer </span>Satisfaction</h4>
                            <p>
                                At {{ $setting->website_name }}, customer satisfaction is our top
                    ...
                    <div class="list-wrap" data-aos="fade-up">
                        <div class="icon">
                            <img src="{{ url('assets/v2/images/icons/icon-4.svg') }}" alt="icon">
                        </div>
                        <div class="description">
                    ...
                    <div class="list-wrap" data-aos="fade-up">
                        <div class="icon">
                            <img src="{{ url('assets/v2/images/icons/icon-5.svg') }}" alt="icon">
                        </div>
                        <div class="description">
