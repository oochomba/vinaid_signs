	            ...
	            <div class="info-column col-xl-3 col-lg-6 col-md-6 col-sm-12">
	                <div class="inner-column d-flex align-items-center">
	                    ...
	                    <div class="content">
	                        ...
	                        @if (!empty($setting->phone))
	                        <a href="https://wa.me/{{ str_replace(' ','',str_replace('+','',$setting->phone)) }}" target="_blank">{{ $setting->phone }}</a>
	                        @endif
	                        @if (!empty($setting->phone_two))
	                        <a href="https://wa.me/{{ str_replace(' ','',str_replace('+','',$setting->phone_two)) }}" target="_blank">{{ $setting->phone_two }}</a>
	                        @endif
	                    </div>
	                </div>
	            </div>
	        ...
	        <div class="row clearfix">
	            ...
	            <div class="image-column col-lg-5 col-md-12 col-sm-12">
	                <div class="inner-column">
	                    <div class="image">
	                        <img src="{{ url('assets/v2/images/resource/contact.jpg') }}" alt="">
	                    </div>
	        ...
	        <div class="lower-box">
	            <div class="row clearfix">
	                ...
	                <div class="video-column col-lg-4 col-md-12 col-sm-12">
	                    ...
	                    <div class="video-box">
	                        <figure class="video-image">
	                            <img class="transition-500ms" src="{{ url('assets/v2/images/resource/video-image.jpg') }}" alt="">
	                        </figure>
	                ...
	                <div class="image-column col-lg-8 col-md-12 col-sm-12">
	                    <div class="image">
	                        <img src="{{ url('assets/v2/images/resource/contact-1.jpg') }}" alt="">
	                    </div>
	                </div>
	            </div>
	        </div>
	        ...
	        <div class="lower-content-box">
	            <div class="row clearfix">
	                <div class="column col-lg-8 col-md-12 col-sm-12">
	                    <h3>Welecome to <span class="big-text">{{ !empty($setting->website_name)?$setting->website_name:'' }}</span> where creativity meats reality</h3>
	                    <p>
	                        In today's rapidly evolving technology landscape, choosing the right partner is
	                        crucial for your business success. At <span class="big-text">{{ !empty($setting->website_name)?$setting->website_name:'' }}</span>,
	                    ...
	                    <p>
	                        At <span class="big-text">{{ !empty($setting->website_name)?$setting->website_name:'' }}</span>, we believe in a collaborative approach to creating exceptional signage
