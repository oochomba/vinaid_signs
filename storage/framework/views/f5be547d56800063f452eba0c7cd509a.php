                ...
                <div class="carousel-inner" role="listbox">
                    <?php if(!empty($sliderImages[0])): ?>
                        <div class="carousel-item active">
                            <img src="<?php echo e($sliderImages[0]->getImageSingle($sliderImages[0]->id)->getImageInfo()); ?>"
                    ...
                    <?php if(!empty($sliderImages[1])): ?>
                        <div class="carousel-item">
                            <img src="<?php echo e($sliderImages[1]->getImageSingle($sliderImages[1]->id)->getImageInfo()); ?>"
                                class="img-fluid" alt="First slide">
                            <div class="carousel-caption">
                                <div class="container carousel-content">
                                    <h6 class="text-secondary h4 animated fadeInUp">
                    ...
                    <?php if(!empty($sliderImages[2])): ?>
                        <div class="carousel-item">
                            <img src="<?php echo e($sliderImages[2]->getImageSingle($sliderImages[2]->id)->getImageInfo()); ?>"
                                class="img-fluid" alt="First slide">
                            <div class="carousel-caption">
                                <div class="container carousel-content">
                                    <h6 class="text-secondary h4 animated fadeInUp">
                    ...
                    <?php if(!empty($sliderImages[3])): ?>
                        <div class="carousel-item">
                            <img src="<?php echo e($sliderImages[3]->getImageSingle($sliderImages[3]->id)->getImageInfo()); ?>"
                                class="img-fluid" alt="First slide">
                            <div class="carousel-caption">
                                <div class="container carousel-content">
                                    <h6 class="text-secondary h4 animated fadeInUp">
                    ...
                    <?php if(!empty($sliderImages[4])): ?>
                        <div class="carousel-item">
                            <img src="<?php echo e($sliderImages[4]->getImageSingle($sliderImages[4]->id)->getImageInfo()); ?>"
                                class="img-fluid" alt="First slide">
                            <div class="carousel-caption">
                                <div class="container carousel-content">
                                    <h6 class="text-secondary h4 animated fadeInUp">
    ...
    <div class="container-fluid services py-5 mb-5" style="background: #ededed">
        <div class="container">
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s">
                ...
                <p>
                    At <span class="big-text"><?php echo e(config('siteconfig.sitename')); ?></span>, we
                ...
                <div class="col-md-6 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                    <div class="list-wrap" data-aos="fade-up">
                        ...
                        <div class="description">
                            ...
                            <p>
                                At <?php echo e(config('siteconfig.sitename')); ?>, customer satisfaction is our top priority. We
                                strive
                                to provide a
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".3s">
                            <div class="project-item">
                                <div class="project-img">
                                    <img src="<?php echo e(!empty($projectImage)?url($projectImage->getImageInfo()):''); ?>" class="img-fluid w-100 rounded"
                                        alt="<?php echo e($project->title); ?>" style="width: 310px; height:254px;">
        ...
        <div class="container text-left aos-init aos-animate" data-aos="zoom-out">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 text-right">
                    <a class="default-theme-btn-one" href="mailto:<?php echo e(config('siteconfig.contacts.email')); ?>">Conatct Us
                        <span></span></a>
                </div>
            </div>
        </div>
        ...
        <div class="container" data-aos="zoom-out" style="">
            <div class="clients-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><img src="<?php echo e(url('assets/v1/front//assets/images/clients/c1.png')); ?>"
                            class="img-fluid" alt="">
                    </div>
...
<?php echo $__env->make($version.'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Obadiah\Desktop\Intel\Intel\vinaid1.4\resources\views/v1/index.blade.php ENDPATH**/ ?>