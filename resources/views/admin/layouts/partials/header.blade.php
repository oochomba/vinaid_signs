  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ url('admin/dashboard') }}" class="brand-link">
          ...
          <span class="brand-text font-weight-light">{{ $setting->website_name }}</span>
      </a>
      @endif -->
      <a href="{{ url('admin/dashboard') }}" class="brand-link">
          <img src="{{ url('assets/dist/img/user2-160x160.jpg') }}" alt="{{ ucwords(Auth::user()->name) }}"
              class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light">{{ ucwords(Auth::user()->name) }}</span>
      </a>
      ...
      <div class="sidebar">
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  ...
                  <li class="nav-item has-treeview {{ Request::segment(2) == 'mockup' ? 'menu-open' : '' }}">
                      <a href="#" class="nav-link {{ Request::segment(2) == 'mockup' ? 'active' : '' }}">
                      ...
                      <ul class="nav nav-treeview">
                          @if ($usr->can('mockup.view'))
                          <li class="nav-item">
                              <a href="{{ url('admin/mockup/list') }}"
                                  class="nav-link {{ Request::segment(2) == 'mockup' && Request::segment(3) == 'list' ? 'active' : '' }}">
                                  <i class="fa fa-circle nav-icon"></i>
                                  <p>Mockup List</p>
                              </a>
                          </li>
                          @endif
                          @if ($usr->can('mockup.create'))
                          <li class="nav-item">
                              <a href="{{ url('admin/mockup/add') }}"
                                  class="nav-link {{ Request::segment(2) == 'mockup' && Request::segment(3) == 'add' ? 'active' : '' }}">
                                  <i class="fa fa-circle nav-icon"></i>
                                  <p>Add Mockup</p>
                              </a>
                          </li>
                  ...
                  @if ($usr->can('page.create'))
                  <li class="nav-item">
                      <a href="{{ url('admin/page/list') }}"
                          class="nav-link {{ Request::segment(2) == 'page' && Request::segment(3) ||Request::segment(2) == 'page' && Request::segment(3) == 'edit' ? 'active' : '' }}">
                  ...
                  <li class="nav-item">
                      <a href="{{ url('admin/banners') }}"
                          class="nav-link {{ Request::segment(2) == 'banners' || Request::segment(2) == 'add-banner' ? 'active' : '' }}">
                          <i class="nav-icon fa fa-photo"></i>
                          <p>
                              Banners
                          </p>
                  ...
                  @if ($usr->can('setting.create') || $usr->can('setting.view'))
                  <li
                      class="nav-item has-treeview {{ Request::segment(2) == 'smtp-setting' || Request::segment(2) == 'system-setting' || Request::segment(2) == 'payment-setting' ? 'menu-open' : '' }}">
                      <a href="#"
                          class="nav-link {{ Request::segment(2) == 'smtp-setting' || Request::segment(2) == 'system-setting' || Request::segment(2) == 'payment-setting' ? 'active' : '' }}">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="{{ url('admin/system-setting') }}"
                                  class="nav-link {{ Request::segment(2) == 'system-setting' ? 'active' : '' }}">
                          ...
                          <li class="nav-item">
                              <a href="{{ url('admin/smtp-setting') }}"
                                  class="nav-link {{ Request::segment(2) == 'smtp-setting' ? 'active' : '' }}">
                          ...
                          @if ($usr->can('paymentsetting.create'))
                          <li class="nav-item">
                              <a href="{{ url('admin/payment-setting') }}"
                                  class="nav-link {{ Request::segment(2) == 'payment-setting' ? 'active' : '' }}">
