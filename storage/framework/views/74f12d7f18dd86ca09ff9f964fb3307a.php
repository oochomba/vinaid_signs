        ...
        <div class="row g-5">
            <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                <div class="h-100 position-relative">
                    <img src="<?php echo e(url('assets/v1/front//img/about1.jpg')); ?>" class="img-fluid w-75 rounded" alt=""
                        style="margin-bottom: 25%;">
                    <div class="position-absolute w-75" style="top: 25%; left: 25%;">
                        <img src="<?php echo e(url('assets/v1/front//img/about2.jpg')); ?>" class="img-fluid w-100 rounded" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                <h5 class="text-primary">About Us</h5>
                <h1>Welcome to <?php echo e(config('siteconfig.sitename')); ?></h1>
                ...
                <p>
                    At <span class="small-text"><?php echo e(config('siteconfig.sitename')); ?>,</span> we believe that signage is
                ...
                <?php if(Request::segment(1) == ''): ?>
                    <a href="<?php echo e(url('about')); ?>" class="btn btn-secondary rounded-pill px-5 py-3 text-white">
                        More Details
                    </a>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\Obadiah\Desktop\Intel\Intel\vinaid1.4\resources\views/v1/_about_intro.blade.php ENDPATH**/ ?>