<div class="container-fluid services py-5 mb-5">
    <div class="container">
        <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s">
            <h5 class="text-primary">Why Choose <?php echo e(config('siteconfig.sitename')); ?>?</h5>
            <p>
        ...
        <div class="row g-5 services-inner featured">
            <p>In today's <span class="big-text">rapidly evolving technology</span> landscape, choosing
                the right partner is crucial for your business success. At <span
                    class="small-text"><?php echo e(config('siteconfig.sitename')); ?></span>, we stand
            ...
            <div class="col-lg-6 left">
                <div class="list-wrap" data-aos="fade-up">
                    <div class="icon">
                        <img src="assets/v1/front//assets/images/icons/icon-1.svg" alt="icon">
                    </div>
                    <div class="description">
                        <h4>Expertise,<span style="color: #c00113;"> Experience</span></h4>
                        <p>
                            With <?php echo e(date('Y') - 2016); ?>+ years of experience in the signage industry, we have
                            the
                ...
                <div class="list-wrap" data-aos="fade-up">
                    <div class="icon">
                        <img src="assets/v1/front//assets/images/icons/icon-3.svg" alt="icon">
                    </div>
                    <div class="description">
                ...
                <div class="list-wrap" data-aos="fade-up">
                    <div class="icon">
                        <img src="assets/v1/front//assets/images/icons/icon-2.svg" alt="icon">
                    </div>
                    <div class="description">
            ...
            <div class="col-lg-6 right">
                <div class="list-wrap" data-aos="fade-up">
                    <div class="icon">
                        <img src="assets/v1/front//assets/images/icons/icon-6.svg" alt="icon">

                    </div>
                    <div class="description">
                        <h4><span style="color: #c00113;">Customer </span>Satisfaction</h4>
                        <p>
                            At <?php echo e(config('siteconfig.sitename')); ?>, customer satisfaction is our top
                ...
                <div class="list-wrap" data-aos="fade-up">
                    <div class="icon">
                        <img src="assets/v1/front//assets/images/icons/icon-4.svg" alt="icon">
                    </div>
                    <div class="description">
                ...
                <div class="list-wrap" data-aos="fade-up">
                    <div class="icon">
                        <img src="assets/v1/front//assets/images/icons/icon-5.svg" alt="icon">
                    </div>
                    <div class="description">
...
<?php /**PATH C:\Users\Obadiah\Desktop\Intel\Intel\vinaid1.4\resources\views/v1/_why_us.blade.php ENDPATH**/ ?>